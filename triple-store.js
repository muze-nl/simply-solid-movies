export default class TripleStore {
    ...
    this.triples = []
		...
		this._availablePredicates = new Set()
		this.makeTripleStore(jsontag)
		this.createIndex()
		console.log(this._availablePredicates)
	}

    makeTripleStore(data, parent=null, predicate=null) {
    	let seen = new Map()
    	let addTriples = (data, parent=null, predicate=null) => {
